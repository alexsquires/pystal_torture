from pystal_torture.node import Node
from pystal_torture.cluster import Cluster
from pystal_torture.graph import Graph
from pystal_torture import dist
...
def nodes_from_structure(structure, rcut, get_halo=False):
    ...
    neighbours = structure.get_all_neighbors(rcut, include_index=True)
    nodes = []
